...
public class NetworkUtil {
	 ...
	 * @return
	 */
	public static boolean checkNetException(String exception) {
		if(!TextUtils.isEmpty(exception) &&(exception.contains("SocketTimeoutException")||exception.contains("Connection")||exception.contains("timeout")||exception.contains("timed out"))){
			return true;
		}
		return false;
	}
