...
public class BasicPathView extends LinearLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("这是一阶贝塞尔曲线,就一条直线", startX, startY / 4, mPaint);
        ...
        //绘制一阶
        mPath.moveTo(startX, startY / 3);// 不会进行绘制，只用于移动移动画笔
        mPath.lineTo(endX, endY / 3);//用于进行直线绘制。
        ...
        mPath.quadTo(touchX, touchY, endX, endY);//用于绘制圆滑曲线，即贝塞尔曲线
        canvas.drawPath(mPath, mPaint);
        mPath.reset();
