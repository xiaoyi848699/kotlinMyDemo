...
public class RightBottomStyle extends LayoutStyle {
    public RightBottomStyle(int layoutRes, int offset) {
        super(layoutRes,offset);
    }

    public RightBottomStyle(int layoutRes) {
        super(layoutRes);
    }

    public RightBottomStyle(View decoView, int offset) {
        super(decoView, offset);
    }

    public RightBottomStyle(View decoView) {
        super(decoView);
    }
