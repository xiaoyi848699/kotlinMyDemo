...
public class CenterTopStyle extends LayoutStyle {
    public CenterTopStyle(int layoutRes, int offset) {
        super(layoutRes,offset);
    }

    public CenterTopStyle(int layoutRes) {
        super(layoutRes);
    }

    public CenterTopStyle(View decoView, int offset) {
        super(decoView, offset);
    }

    public CenterTopStyle(View decoView) {
        super(decoView);
    }
