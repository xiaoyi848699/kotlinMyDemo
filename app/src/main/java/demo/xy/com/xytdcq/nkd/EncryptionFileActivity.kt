...
import demo.xy.com.xytdcq.nkd.encryption.EncryptionFile
...
class EncryptionFileActivity : BaseAtivity() {
    ...
    init {
        System.loadLibrary("file-crypt-lib")
    }
        ...
        when (v.id) {
            ...
            R.id.encrypt ->{
                if(TextUtils.isEmpty(filePath)){
                    ...
                    try{
                        EncryptionFile.CryptorEncrypt(this!!.filePath!!, this!!.decryptPath!!)
                ...
                if(TextUtils.isEmpty(decryptPath)){
                    ...
                    try{
                        ...
                        if(strs!!.size == 2){
                            ...
                            EncryptionFile.CryptorDecrypt(this!!.decryptPath!!,newPath)
