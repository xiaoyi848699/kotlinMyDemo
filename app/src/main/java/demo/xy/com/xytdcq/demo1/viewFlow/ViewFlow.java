 ...
 */
package demo.xy.com.xytdcq.demo1.viewFlow;
...
//		}
////		LogUtil.d("TAG", "dis"+count);
//		return false;//ture  ���Ի��������ɵ��  false  ���Ե�������ܻ���
////		if(count<5&&up){
////			LogUtil.d("TAG", "false");
////			return false;//ture  ���Ի��������ɵ��  false  ���Ե�������ܻ���
////		}else{
////			LogUtil.d("TAG", "true");
////			return true;//ture  ���Ի��������ɵ��  false  ���Ե�������ܻ���
////		}
//	}
...
//			requestDisallowInterceptTouchEvent(false);
	...
	/**
	 * 
	 * @param whichScreen ��һ��Ҫѡ���item
	 */
	private void snapToScreen(int whichScreen) {
//		LogUtil.d("TAH", "mLastScrollDirection"+mLastScrollDirection);
//		LogUtil.d("TAH", "whichScreen"+whichScreen);
//		LogUtil.d("TAH", "mCurrentScreen"+mCurrentScreen);
...
//		LogUtil.d("TAH", "whichScreen"+whichScreen);
//		LogUtil.d("TAH", "mNextScreen"+mNextScreen);
