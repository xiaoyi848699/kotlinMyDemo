...
import demo.xy.com.xytdcq.view.pull.layoutmanager.ILayoutManager;


/**
 * 核心控制器, 负责下拉刷新和加载更多(无法与表格混合布局)
 */
public class PullRecycler extends FrameLayout implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void setLayoutManager(ILayoutManager mLayoutManager) {
        ...
        mRecycleView.setLayoutManager(mLayoutManager.getLayoutManager());
    }
